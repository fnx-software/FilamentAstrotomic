...
class FilamentAstrotomicServiceProvider extends PackageServiceProvider
{
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('fnx-software/filamentastrotomic');
            });
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/filamentastrotomic/{$file->getFilename()}"),
                ], 'filamentastrotomic-stubs');
            }
        }
    ...
    {
        return 'fnx-software/filamentastrotomic';
    }
    ...
    {
        return [
            // AlpineComponent::make('filamentastrotomic', __DIR__ . '/../resources/dist/components/filamentastrotomic.js'),
            Css::make('filamentastrotomic-styles', __DIR__ . '/../resources/dist/filamentastrotomic.css'),
            Js::make('filamentastrotomic-scripts', __DIR__ . '/../resources/dist/filamentastrotomic.js'),
        ];
    }
